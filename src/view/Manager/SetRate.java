...
public class SetRate extends JDialog implements AddListener{
    ...
    public SetRate(Window owner) {
        ...
        message1 = new JLabel("Current Rate: ");

        rate = new JLabel(service.getRate().toString());
        message2 = new JLabel("New Rate: ");
    ...
    private void update(){
        int pick = Integer.valueOf(amount.getText());

        if(service.changeRate(pick)){
            this.dispose();
